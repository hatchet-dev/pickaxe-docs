---
title: "Project Structure and Entrypoints"
description: "Understanding the entrypoints of your Pickaxe application."
---

# Project Structure

The recommended structure for a Pickaxe application is to have a single entrypoint that imports your agents and tools, and starts the Pickaxe client.
