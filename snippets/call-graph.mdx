...
{ from: 1, to: 2, label: 'agent.run()', top: 119, dashed: false, link: '/api-reference/agent' },
{ from: 2, to: 3, label: 'tool.run()', top: 148, dashed: false, link: '/api-reference/tool' },
{ from: 3, to: 4, label: 'External Call', top: 177, dashed: false },
{ from: 4, to: 3, label: 'Response', top: 206, dashed: true },
{ from: 3, to: 2, label: 'Tool Result', top: 235, dashed: true },
{ from: 2, to: 1, label: 'Agent Response', top: 264, dashed: true },
{ from: 1, to: 0, label: 'API Response', top: 293, dashed: true }
];
