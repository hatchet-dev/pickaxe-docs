...
1. **Dependency Injection**: Use NestJS DI system for managing agent services
2. **Configuration Management**: Use ConfigModule for environment variables
3. **Error Handling**: Implement proper error handling with HTTP exceptions
4. **Logging**: Use NestJS Logger for structured logging
5. **Validation**: Use DTOs with class-validator for input validation
6. **Testing**: Write comprehensive unit and integration tests
7. **Background Processing**: Consider using queues for long-running agents
